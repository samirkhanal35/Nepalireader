...
static PyMethodDef __pyx_mdef_12monochromize_1monochrome = {"monochrome", (PyCFunction)__pyx_pw_12monochromize_1monochrome, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 *     cdef int b = int(num2)
 */
  __pyx_tuple__22 = PyTuple_Pack(8, __pyx_n_s_num1, __pyx_n_s_num2, __pyx_n_s_img, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_img1, __pyx_n_s_i, __pyx_n_s_j); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(3, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_monochromize_pyx, __pyx_n_s_monochrome, 4, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 4, __pyx_L1_error)
...
static int __pyx_pymod_exec_monochromize(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init monochromize", 0, __pyx_lineno, __pyx_filename);
    }
