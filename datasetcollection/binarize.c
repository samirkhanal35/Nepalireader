...
static PyMethodDef __pyx_mdef_8binarize_1binarize = {"binarize", (PyCFunction)__pyx_pw_8binarize_1binarize, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 *     cdef img1 = view.array(shape=(num1,num2), itemsize=sizeof(int), format="i")
 */
  __pyx_tuple__22 = PyTuple_Pack(6, __pyx_n_s_num1, __pyx_n_s_num2, __pyx_n_s_img, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_img1); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(3, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_binarize_pyx, __pyx_n_s_binarize, 4, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 4, __pyx_L1_error)
...
static int __pyx_pymod_exec_binarize(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init binarize", 0, __pyx_lineno, __pyx_filename);
    }
